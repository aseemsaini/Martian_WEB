...
public class routes {
  ...
  public static final controllers.Reversefinance finance = new controllers.Reversefinance(RoutesPrefix.byNamePrefix());
  ...
  public static class javascript {
    ...
    public static final controllers.javascript.Reversefinance finance = new controllers.javascript.Reversefinance(RoutesPrefix.byNamePrefix());
